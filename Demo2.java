public class Demo2 {
    public static void main(String[] args) {
        ...
        /* We can specify the flag 
           "-" (which stands for left align) 
           with any data type */
        System.out.printf("| %-6s |\n", myStr);
        System.out.printf("| %-6d |\n", myInt);
        System.out.printf("| %-6.2f |\n", myDouble);
        ...
        /* We can specify the flag 
           "+" (which stands for negative/positive sign) 
           with only numeric data types (floats, decimals, etc.) */        
        System.out.printf("| %+-6d |\n", myInt);
        System.out.printf("| %+-6.2f |\n", myDouble);
        System.out.println();        

        /* We can specify the flag 
           "0" (which stands for zero padding)
           with only numeric data types (floats, decimals, etc.) */          
        ...
        System.out.println(); 
         ...
         /* We can specify the flag 
           "," (which stands for thousand grouping)
           with only numeric data types (floats, decimals, etc.) */   
